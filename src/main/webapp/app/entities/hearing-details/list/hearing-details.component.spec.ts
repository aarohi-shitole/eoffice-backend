...
describe('HearingDetails Management Component', () => {
  let comp: HearingDetailsComponent;
  let fixture: ComponentFixture<HearingDetailsComponent>;
  let service: HearingDetailsService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'hearing-details', component: HearingDetailsComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(HearingDetailsComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.hearingDetails?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
