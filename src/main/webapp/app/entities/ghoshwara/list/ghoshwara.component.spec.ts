...
describe('Ghoshwara Management Component', () => {
  let comp: GhoshwaraComponent;
  let fixture: ComponentFixture<GhoshwaraComponent>;
  let service: GhoshwaraService;

  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'ghoshwara', component: GhoshwaraComponent }]), HttpClientTestingModule],
      ...
      .overrideTemplate(GhoshwaraComponent, '')
      .compileComponents();
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.ghoshwaras?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
